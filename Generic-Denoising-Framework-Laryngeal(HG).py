...
# ## **Laryngeal Denoising  using DCNN Framework**
...
train_files=['Laryngeal/train/images/'+filename for filename in os.listdir('Laryngeal/train/images/')]
test_files=['Laryngeal/test/images/'+filename for filename in os.listdir('Laryngeal/test/images/')]
